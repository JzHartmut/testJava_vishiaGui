...
cd /D %~dp0
set ARGS=%1
if "" == "%ARGS%" set ARGS=c:/BATCH/Fcmd.cfg/Fcmd.args
echo %ARGS%
set LOGDIR=%TMP%\Fcmd
...
@echo on  
javaw -cp ../../../../cmpnJava_vishiaBase/deploy/vishiaBase-2020-03-20.jar;../../../deploy/vishiaGui-2020-03-20.jar;../../../libs/%SWTJAR% org.vishia.commander.Fcmd --@%ARGS% 1>%LOGDIR%\log1.txt 2>%LOGDIR%\err1.txt
@echo off
